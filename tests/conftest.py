...
os.environ.setdefault("MINIO_ENABLE", "0")          # skip MinIO path
os.environ.setdefault("RQ_ENABLE", "0")             # use FastAPI BackgroundTasks
os.environ.setdefault("WHISPER_ENABLE", "0")        # don't call Whisper
os.environ.setdefault("GPT_ENABLE", "0")            # don't call GPT for summary
os.environ.setdefault("NOTABLY_ADMIN_TOKEN", "test-admin")
# Leave NOTABLY_API_KEY unset so auth-lite is disabled during tests
...
def client():
    # Single TestClient shared for speed
