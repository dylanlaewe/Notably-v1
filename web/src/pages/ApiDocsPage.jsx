  ...
  http://localhost:8000/v1/uploads/8f2a2a2e-8b35-4e25-9d5e-6f9b5f8a6e7d/result`}</code></pre>
          ...
          <section id="openapi" className="docs-section">
            ...
            <div className="openapi-info">
              <p>
                The complete OpenAPI specification is automatically generated by FastAPI and available at:
              </p>
              <div className="openapi-links">
                <a href="http://localhost:8000/docs" className="openapi-link" target="_blank" rel="noopener noreferrer">
                  📖 Interactive Docs (Swagger UI)
                </a>
                <a href="http://localhost:8000/redoc" className="openapi-link" target="_blank" rel="noopener noreferrer">
                  📋 ReDoc Documentation
                </a>
                <a href="http://localhost:8000/openapi.json" className="openapi-link" target="_blank" rel="noopener noreferrer">
                  📄 Raw OpenAPI JSON
                </a>
              </div>
            </div>
